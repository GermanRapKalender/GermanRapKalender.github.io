...
namespace GermanRapKalenderUI.Helper
{
	class RegistryHandler
	{
        ...
        */
		...
		public static void SetValue(RegistryKey pRKey, string pValue, string pData, RegistryValueKind pRegistryValueKind)
		{
			...
			{
				Logger.Log("haha regedit goes boom while writing");
				Logger.Log("pRKey: '" + pRKey.ToString() + "', pValue: '" + pValue + "', pData:'" + pData + "', pRegistryValueKind: '" + pRegistryValueKind.ToString() + "'", 1);
			}
		}
		...
		public static void DeleteKey(RegistryKey pKey)
		{
			...
			{
				Logger.Log("Deleting Regedit failed: " + e.ToString());
		...
		public static string GetValue(RegistryKey pRKey, string pValue)
		{
			...
			catch
			{
				if (pRKey == null)
				{
					Logger.Log("haha regedit goes boom while reading. Function will return \"\". pRKey is null");
				}
				else
				{
					Logger.Log("haha regedit goes boom while reading. Function will return \"\". pRKey: '" + pRKey.ToString() + "', pValue: '" + pValue + "'", 1);
				}
			}
			return rtrn;
		}
